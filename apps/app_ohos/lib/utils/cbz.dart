import 'dart:convert';
import 'package:venera/utils/ohos_7zip.dart';
...
import 'package:venera/utils/ohos_zip.dart';
...
abstract class CBZ {
  ...
  static Future<void> extractArchive(File file, Directory out) async {
    ...
    if (fileType.mime == 'application/zip') {
      await ZipFile.openAndExtractAsync(file.path, out.path, numThreads: 4);
  ...
  static _compress(String src, String dst) async {
    await ZipFile.compressFolderAsync(src, dst, numThreads: 4);
  }
}
