            ...
            onChanged: () async {
              ...
              if (current) {
                final bool canAuthenticateWithBiometrics =
                    await OhosLocalAuth.canCheckBiometrics();
                final bool canAuthenticate = canAuthenticateWithBiometrics ||
                    await OhosLocalAuth.isDeviceSupported();
                if (!canAuthenticate) {
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      OhosUrlLauncher.launchUrlString("https://github.com/venera-app/venera/blob/b08f11f6ac49bd07d34b4fcde233ed07e86efbc9/lib/foundation/appdata.dart#L138");
                                    },
                                  ),
                                ),
                              ],
